...
export class TradeComponent implements OnInit {
  ...
  tradeAsset = new FormControl('', Validators.required);
  ...
  addTransaction(form: any): Promise<any> {
    this.Transaction = {
      ...
      'tradeAsset': this.tradeAsset.value,
  ...
  getForm(id: any): Promise<any> {
    ...
    .then((result) => {
      ...
      if (result.tradeAsset) {
        formObject.tradeAsset = result.tradeAsset;
      } else {
        formObject.tradeAsset = null;
      }
