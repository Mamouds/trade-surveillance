...
export class CustomerComponent implements OnInit {
  ...
  identifier_type = new FormControl('', Validators.required);
  ...
  getForm(id: any): Promise<any> {
    ...
    .then((result) => {
      ...
      if (result.identifier_type) {
        formObject.identifier_type = result.identifier_type;
      } else {
        formObject.identifier_type = null;
      }
